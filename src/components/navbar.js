    ...
    render() {
        const navigationContainer = (<div className={classNames('navigation')}>
            <div className="navigationContent">
                <ul>
                    <li><Link to="/" className="about effect-shine" onClick={ () => this.navigationBtnClick('home')}>Home</Link>
                    </li>
                    {/*<li><Link to="pageOne" className="about effect-shine" onClick={ () => this.navigationBtnClick('home')}>About</Link></li>*/}
                    <li><a href="/resume.pdf" className="resume effect-shine" target="_blank"
                           onClick={ () => this.navigationBtnClick('home')}>Resume</a></li>
                    <li><Link to="Work" className="work effect-shine" onClick={ () => this.navigationBtnClick('work')}>Work</Link>
                    </li>
                    {/*<li><Link href="/blog/" to="pageTwo" className="work effect-shine" onClick={ () => this.navigationBtnClick('home')}>pageTow</Link></li>*/}
                    <li><a href="/blog/" target="_blank" className="work effect-shine"
                           onClick={ () => this.navigationBtnClick('blog')}>Blog</a></li>
        ...
        return (
            ...
            <header className="headerWrap App-content clearfix">
                ...
                <div className="menuBtn" onClick={() => this.menuButton()}>
                    <div id="menu-icon"
